...
public class ChromiumArmorEffect extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(PixaleArmorMaterials.CHROMIUM,
                            List.of(new StatusEffectInstance(StatusEffects., 400, 2, false, false),
                                    new StatusEffectInstance(StatusEffects.JUMP_BOOST, 400, 1, false, false))).build();

    public ChromiumArmorEffect(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
